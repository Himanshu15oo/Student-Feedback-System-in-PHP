...
try {
    ...
    foreach($emails as $email)
    {
        ...
        $mail->Body    = '<pre><h4 style = "font-size:.8rem">Dear students,<br><br>   Fill out the faculty feedback form<br><a href="http://localhost:8888/ERP2/ERP/feedback.html">Click here to fill feedback form</a><br><br>Thanks and regards,</h4></pre>';

        
        $mail->send();
        echo '<script>alert("Feedback form sent!!")</script>';
        } catch (Exception $e) {
...
if(isset($_POST['sendFeedback']))
  {
    $result = mysqli_query($connection,"SELECT email FROM students where response = 0");
    $emails = Array();
  ...
  //   print_r(mysqli_fetch_assoc($emails));
  //   sendMail(mysqli_fetch_assoc($emails));
  // }
                        ...
                        <div class="form-group form-control-md row">
                            ...
                            <div class="col-sm-9 ">
                                <select class="js-example-basic-single form-control" name="branch">
                                    ...
                                    <option value="ENTC">Electronics and
                                        Telecommunication Engineering</option>
                                    <option value="ETX">Electronics Engineering</option>
                                    <option value="MECH">Mechanical Engineering</option>
                                    <!-- <option value="DESIGN">Mechanical Engineering</option> -->
                                </select>
                            </div>
                        </div>
