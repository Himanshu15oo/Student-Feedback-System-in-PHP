        ...
        <tr>
          ...
          $counter=0;
            while ($row_course=mysqli_fetch_assoc($result_course)) {
                ...
                $from_course="SELECT * FROM course where id = ".$row_course['course_id'];
                $from_faculty="SELECT * FROM faculty where id = ".$row_course['faculty_id'];
                if ($result111 = mysqli_query($connection,$from_course)) {

                if ($result112 = mysqli_query($connection,$from_faculty)) {
                
                while ($row111 = $result111->fetch_assoc() and $row112 = $result112->fetch_assoc()) {
          ...
          ?>
            ...
            <td><?php echo $row112["name"]; ?></td>
            <td><?php echo $row111['name']; ?></td>
